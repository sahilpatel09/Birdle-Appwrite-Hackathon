<template>
  <div>
    <div class="block" v-if="true">
        ...
        <div class="flex flex-row justify-between">
          ...
          >
            ...
            >
              ...
              <div class="hidden lg:block lg:flex lg:justify-center">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
                ...
                <div
                  class="w-5 h-5 bg-green-600 rounded-full -ml-3.5 -mt-1 text-xs flex items-center justify-center text-white"
                  :class="{ hidden: !haveNotifications }"
                >
                  12
                </div>
              </div>
          ...
          >
            <div class="block">
              ...
              <div
                class="lg:hidden py-4 px-6 mx-6 my-4 rounded h-14 bg-gray-100"
              >
                <h2 class="flex gap-3 items-center font-semibold">
                  <div class="rounded-full bg-green-700 w-3 h-3"></div>
                  <span class="text-green-500">War in Ukraine:</span> What We’re
                  Reading
                </h2>
              </div>
                  ...
                  <div class="flex justify-between gap-5">
                    <div class="space-y-4 pt-3">
                      ...
                      <p class="hidden lg:block postDescription">
                        A transcendental drowning — “Oh Khusrau, the river of
                        love Runs in strange directions. One who jumps into it
                        drowns,
                      </p>
      ...
      <UserBottomLeftMenu :class="{ hidden: menu }" class="z-50" />
    </div>
    <div v-else>
      <Loading />
