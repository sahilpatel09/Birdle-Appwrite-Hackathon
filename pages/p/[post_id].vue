...
<!--             <div class="w-full h-10 bg-red-300 flex items-center justify-center py-3">
          ...
          <div class="mt-20 w-full flex items-center justify-start p-2 flex-wrap bg-gray-200">
            ...
            <input type="submit" class="hidden">
              ...
              <button class="rounded-full bg-green-700 px-5 py-2 text-white" @click="chooseTheWay($event)" name="publish">Publish Story</button>
              <button class="ml-2 rounded-full bg-green-700 px-5 py-2 text-white" @click="chooseTheWay($event)" name="draft">Make a Draft</button>
