<template>
  <div>
    <div class="container mx-auto lg:px-20 px-10 py-5">
      <div class="flex items-center justify-between mb-10">
        <div class="flex items-center gap-3">
          ...
          <h3 class="textfont font-medium text-3xl globalfont">
            Birdle
          </h3>
        </div>
    ...
    <div class="px-20 py-12 space-y-10">
      ...
      <div class="flex items-center justify-center gap-20">
       ...
       <div class="flex flex-col">
        <input type="text" v-model="name" name="" class="w-[660px] h-10 px-3 border-b-2 border-gray-600" placeholder="Publication Name">
        <p class="px-3">Link to <span class="text-black  font-bold">medium-lac.vercel.app/YOUR_PUBLICATION_NAME</span></p>	     		
      </div>
    ...
    <div class="flex items-center justify-center gap-20">
      ...
      <div class="flex flex-col">
        <textarea v-model="desc" type="text" name="" class="w-[660px] px-3 border-b-2 border-gray-600" placeholder="Write about your publication...." maxlength="300" rows="3" cols="3"></textarea>
        <p class="px-3">Description in detil about your publication.<span class="text-black  font-bold">Max 300 characters.</span></p>          
      </div>
    ...
    <div class="flex items-center ml-10 gap-20">
      ...
      <div class="flex flex-col">
        <input type="file" accept="image/*" name="" class="px-3" v-on:change="send($event)" />
        <p class="px-3">Choose a logo of 300px * 300px.</p>          
        
      </div>
<img :src="pubImageShowURL" alt="" v-if="pubImageShowURL" class="w-40 border-2 border-gray-400">
