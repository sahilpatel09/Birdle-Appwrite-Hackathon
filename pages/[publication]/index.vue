              ...
              <div class="my-3 space-y-10" v-for="(post, index) in pubPost">
                <div class="flex justify-between gap-5">
                  <div class="space-y-4 pt-3">
                    ...
                    >
                      <div
                        class="profile hidden lg:block w-5 h-5"
                        @click="openIt"
                        v-if="pubInfo"
                      >
                        <UsersUserAvatar
                      ...
                      <p class="py-1">
                        Published in
                        <span class="font-bold">{{ pubInfo.name }}</span>
                      </p>
            ...
            <section class="my-5">
              <div class="dataholder">
                ...
                <h3 class="py-2 text-base text-gray-500">
                  {{ pubInfo.followers_count }} Followers
                </h3>
                ...
                <div v-if="pubInfo && userData">
                  <h4
                    ...
                    v-if="pubInfo.user_id == userData.$id"
                  >
...
async function getStuff() {
  ...
  const { pub, posts } = await service.getPubWithPosts(
