        ...
        <div class="block">
          <div class="mx-6 my-4">
            <div class="lg:flex flex-col lg:gap-2 justify-center">
              <div class="flex items-center justify-between py-2">
                <div class="w-full flex items-center justify-start gap-4">
                  ...
                  <h4 class="text-sm text-gray-600 globalfont">
                    Published in
                    <span class="text-gray-800">{{ pubinfo.name }}</span>
                  </h4>
                </div>
              </div>
              ...
              <div v-html="postItem.content" class="globalfont text-lg"></div>
            </div>
          </div>
        </div>
      </div>
              ...
              <section class="my-5">
                <div class="dataholder">
                  ...
                  <h3 class="py-2 text-base text-gray-500">
                    {{ postUser.followers_count }} Followers
                  </h3>
...
async function getPostFromPublication() {
  const { pubInfo, userInfo, postInfo } =
    await service.getPostWithPubAuthorData(
