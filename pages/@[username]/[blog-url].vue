            ...
            <div class="lg:flex flex-col lg:gap-2 justify-center">
              <div class="flex items-center justify-between py-2">
                <div class="w-full flex items-center justify-start gap-4">
                  <div
                    class="profile lg:block lg:w-12 w-10"
                    @click="openIt"
                    v-if="user"
                  >
              ...
              <div class="w-full bg-gray-100 px-4 py-2 my-2 rounded">
                You have <span class="text-black font-bold">2</span> free
                member-only stories left this month. Sign up for Birdle and get
                an extra one.
              </div>
              ...
              <div class="flex itens-center justify-between w-full h-14 mt-5">
                <div class="flex items-center gap-3 globalfont">
                  ...
                  <div class="flex flex-col justify-between">
                    ...
                    <p class="text-sm">
                      {{ postDate }} · {{ postItem.readTime }} min read
                    </p>
                  </div>
                </div>
              ...
              <div class="mt-3">
                <h3
                  class="capitalize globalfont text-4xl font-extrabold"
                  v-if="postItem"
                >
                  {{ postItem.name }}
                </h3>
...
async function getSinglePost() {
  const { post, info } = await service.getAuthorPost(
    route.params.username,
    route.params.blogurl
  );
