<template>
  ...
  <input type="file" id="img" name="img" v-on:change="send($event)" accept="image/*">
...
function send(event){
    ...
    let promise = appwrite.storage.createFile('625f78027b24b0de372e', "unique()" ,event.target.files[0]);
